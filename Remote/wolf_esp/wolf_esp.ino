 ...
 *uid = Uid_Hex(rfid.uid.uidByte, rfid.uid.size);
 ...
 if ((WiFi.status() == WL_CONNECTED)) { //Check the current connection status
    ...
    http.begin("https://gestion.eirlab.net/api/index.php/members?sortfield=t.rowid&sortorder=ASC&limit=600"); //Specify the URL
    http.addHeader("Accept", "application/json");
    http.addHeader("DOLAPIKEY", "sPfJjheCExeL");
